...
export default class SculpturesScreen extends React.Component {

  constructor(props)
  {
    super(props);    
    language==='gr'? this.state = {FlatListItems: titlesSculptures} : this.state = {FlatListItems: titlesEnSculptures}
  }

  static navigationOptions = ({navigation}) => {
      return {
        title: language==='gr'?'Γλυπτική':'Sculptures',
