...
export default class MuseumsScreen extends React.Component {

  constructor(props)
  {
    super(props);    
    language==='gr'? this.state = {FlatListItems: titlesMuseums} : this.state = {FlatListItems: titlesEnMuseums}
  }

  static navigationOptions = ({navigation}) => {
      return {
        title: language==='gr'?'Μουσεία':'Museums',
