...
export default class BuildingsScreen extends React.Component {

  constructor(props)
  {
    super(props);    
    language==='gr'? this.state = {FlatListItems: titlesBuildings} : this.state = {FlatListItems: titlesEnBuildings}
  }

  static navigationOptions = ({navigation}) => {
      return {
        title: language==='gr'?'Κτίρια':'Buildings',
